...
CREATE TABLE teacher_reviews (
  ...
  rating_course_balance SMALLINT NOT NULL CHECK (rating_course_balance BETWEEN 1 AND 5),
  rating_grading_fairness SMALLINT NOT NULL CHECK (rating_grading_fairness BETWEEN 1 AND 5),
